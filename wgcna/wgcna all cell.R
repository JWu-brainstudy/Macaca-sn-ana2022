...
x <- AverageExpression(data1,group.by = "ident")$RNA
...
ggsave("sampleClustering_allcelltype.png",height = 9,width = 12)
...
ggsave("soft-thresholding power_allcelltype.png",height = 6,width = 12)
...
ggsave("cluster Dendrogram_allcelltype.png",height = 9,width = 12)
...
ggsave("cluster-dynamic Dendrogram_allcelltype.png",height = 9,width = 12)
...
write.xlsx(meta2module, "meta2module_allcelltype.xlsx", overwrite = T, rowNames = T)
nGenes = ncol(x);
nSamples = nrow(x);
...
p.orign
ggsave("wgcna_allcelltype.pdf", width = 12, height = 5)
ggsave("wgcna_allcelltype.png", width = 12, height = 5)
